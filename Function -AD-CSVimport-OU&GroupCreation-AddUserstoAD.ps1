function ImportCSVandCreateNewUser {
  <#
   .Synopsis
    This function imports a CSV file containing new users to be added to AD

   .Description
    This function imports CSV file and creates new OU's and Groups not already created in AD.  It then adds users to AD and places them into the right OU/Group

   .Parameter Path
    The path to the source file - E:\newhires.csv

   .Notes
    NAME:  Import Data for Active Directory
    AUTHOR: Mike Gogue
    LASTEDIT: 08/30/2023 14:21:22
    KEYWORDS: Import CSV for AD

   .Link
    Project https://github.com/MSSA-AU/ClassInfo/blob/main/PowerShellTraining/PSADProject1.md
